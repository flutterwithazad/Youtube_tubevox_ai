    ...
    >
      ...
      {mobileOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-background border-b border-border shadow-xl p-4 flex flex-col gap-4">
          ...
          <Link href="/login" className="font-semibold p-2">Log in</Link>
          <Link href="/dashboard" className="w-full text-center font-bold bg-primary text-primary-foreground px-5 py-3 rounded-xl shadow-md">
            Start for free →
          </Link>
        </div>
      )}
