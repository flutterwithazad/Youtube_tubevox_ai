    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          <a href="/dashboard/login" className="text-sm font-semibold hover:text-primary transition-colors">Log in</a>
          <a 
      ...
      {mobileOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-background border-b border-border shadow-xl p-4 flex flex-col gap-4">
          ...
          <a href="/dashboard/login" className="font-semibold p-2">Log in</a>
