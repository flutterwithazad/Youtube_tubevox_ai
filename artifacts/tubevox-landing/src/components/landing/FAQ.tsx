...
export function FAQ({ freeCredits = '500' }: Props) {
  ...
  const faqs = [
    ...
    { q: "How does pricing work?", a: "TubeVox is completely credit-based — no subscriptions. 1 credit = 1 comment. Buy a credit pack once and use it whenever you need. Credits never expire." },
    ...
    { q: "Will I get blocked by YouTube?", a: "No. TubeVox runs on our distributed cloud infrastructure, not your browser. You use our IPs and proxies, so your personal YouTube account is never at risk." },
